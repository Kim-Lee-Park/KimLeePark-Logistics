...
import com.klp.order.order.infrastructure.event.event.InventoryDeductedEvent;
import com.klp.order.order.infrastructure.event.event.InventoryDeductedFailedEvent;
