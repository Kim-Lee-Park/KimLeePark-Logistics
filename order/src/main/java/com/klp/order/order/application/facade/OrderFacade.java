package com.klp.order.order.application.facade;

import com.klp.order.global.exception.BusinessException;
import com.klp.order.global.exception.OrderErrorCode;
import com.klp.order.order.application.command.CancelOrderCommand;
import com.klp.order.order.application.command.CreateOrderCommand;
import com.klp.order.order.application.command.OrderItemCommand;
import com.klp.order.order.application.query.ProductQueryService;
import com.klp.order.order.application.query.UserQueryService;
import com.klp.order.order.application.service.OrderOutboundRequestService;
import com.klp.order.order.application.service.OrderOutboxEventService;
import com.klp.order.order.application.service.OrderService;
import com.klp.order.order.application.service.UserClient;
...
import com.klp.order.order.infrastructure.client.service.InventoryIntegrationService;
import com.klp.order.order.infrastructure.client.service.PromotionDiscountService;
import com.klp.order.order.infrastructure.event.event.OrderCancelledEvent;
import com.klp.order.order.infrastructure.event.event.OrderCreatedEvent;
