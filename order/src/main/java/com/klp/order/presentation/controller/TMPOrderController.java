...
@RestController
@RequestMapping("/tmp/v1/orders")
@RequiredArgsConstructor
public class TMPOrderController implements OrderControllerDoc {

    private final OrderService orderService;
    private final TMPOrderFacade orderFacade;
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(
        ...
        URI location = URI.create("/tmp/v1/orders");
