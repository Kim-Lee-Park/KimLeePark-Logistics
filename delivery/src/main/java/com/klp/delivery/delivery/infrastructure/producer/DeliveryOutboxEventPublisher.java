...
public class DeliveryOutboxEventPublisher {
    ...
    public void publishPendingEvents() {
        List<DeliveryOutboxEvent> pendingEvents =
            deliveryOutboxEventRepository.findPendingEvents();
        ...
        for (DeliveryOutboxEvent event : pendingEvents) {
    ...
    public void recoverStuckPublishingEvents() {
        try {
            List<DeliveryOutboxEvent> stuckEvents =
                deliveryOutboxEventRepository.findStuckPublishingEvents();
            ...
            for (DeliveryOutboxEvent event : stuckEvents) {
    ...
    public void monitorFailedEvents() {
        try {
            List<DeliveryOutboxEvent> failedEvents =
                deliveryOutboxEventRepository.findFailedEvents();
            ...
            for (DeliveryOutboxEvent event : failedEvents) {
