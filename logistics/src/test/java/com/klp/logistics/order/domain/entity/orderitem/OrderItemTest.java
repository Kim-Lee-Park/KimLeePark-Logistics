...
import com.klp.logistics.order.domain.entity.orderitem.OrderItem;
...
public class OrderItemTest {
    ...
    @Test
    @DisplayName("주문 아이템 생성시 상품ID 가 Null 이면 예외가 발생한다")
    ...
    @Test
    @DisplayName("주문 아이템 생성시 수량이 0 이하면 예외가 발생한다")
    ...
    @Test
    @DisplayName("주문 아이템 생성시 Order가 Null이면 예외가 발생한다")
    ...
    @Test
    @DisplayName("주문에 배송ID 를 할당할 수 있다")
    ...
    @Test
    @DisplayName("주문 수량 변경시 수량이 0 이면 예외가 발생한다")
