package com.klp.promotion.global.config;
...
public class RedisCacheConfig {
    ...
    private static final String KEY_PREFIX = "promotion-cache:";
    ...
    public RedisCacheManager redisCacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("coupon", redisCacheConfig.entryTtl(ROUTE_PLAN_CACHE_EXPIRATION));
